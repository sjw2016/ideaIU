...
public interface RedisDao {
     ...
     * @return
     */
    Void setex(final String key, final Long timeout, final String value);
    /**
     * 字符串类型:
     ...
     * @return
     */
    Void setrange(final String key, final String value, final Long offset);
    /**
     * 字符串类型:
     ...
     * @return
     */
    byte[] getrange(final String key, final Long start, final Long end);
    /**
     * 字符串类型:
     ...
     * @return
     */
    Void mset(final Map<byte[], byte[]> map);
    /**
     * 字符串类型:一次性获取多个key对应的value列表
     * @param bytes
     * @return
     */
    List<byte[]> mget(final byte[]... bytes);
    /**
     * 字符串类型:
     ...
     * @return
     */
    Boolean msetnx(final Map<byte[], byte[]> map);
    /**
     ...
     * @return
     */
    byte[] lindex(final String key, final Long offset);
    /**
     ...
     * @return
     */
    Long sadd(final String key, final byte[]... bytes);
    /**
     * set无序集合类型:
     * 返回key集合所有的元素
     * @param key
     * @return
     */
    Set<byte[]> smembers(final String key);
    /**
     ...
     * @return
     */
    Long srem(final String key, final byte[]... bytes);
    /**
     * set无序集合类型:
     ...
     * @return
     */
    Set<byte[]> sinter(final byte[]... bytes);
    /**
     * set无序集合类型:
     ...
     * @return
     */
    Long sinterstore(final String key, final byte[]... bytes);
    /**
     * set无序集合类型:
     ...
     * @return
     */
    Set<byte[]> sunion(final byte[]... bytes);
    /**
     * set无序集合类型:
     ...
     * @return
     */
    Long sunionstore(final String key, final byte[]... bytes);
    /**
     * set无序集合类型:
     * @param key1    被移除的集合
     ...
     * @return
     */
    Boolean smove(final String key1, final String key2, final String field);
    /**
     ...
     * @return
     */
    Boolean zadd(final String key, final Double offset, final byte[] bytes2);
    /**
     ...
     * @return
     */
    Long zrem(final String key, final byte[]... bytes);
    /**
     ...
     */
    Double zincrby(final String key, final Double offset, final String field);
    /**
     ...
     * @return
     */
    Set<byte[]> zrangebyscore(final String key, final Double start, final Double end);
    /**
     ...
     * @return
     */
    Long zremrangebyrank(final String key, final Double start, final Double end);
    /**
     ...
     * @return
     */
    Long zcount(final String key, final Double start, final Double end);
    /**
     * hash类型:
     ...
     * @return
     */
    Long hdel(final String key, final byte[]... fields);
    /**
     ...
     * @return
     */
    Void hmset(final String key, final Map<byte[], byte[]> map);
    /**
     ...
     * @return
     */
    List<byte[]> hmget(final String key, final byte[]... fields);
    /**
     * hash类型:
     ...
     * @return
     */
    Boolean hsetnx(final String key, final String field, final String value);
    /**
     * hash类型:
